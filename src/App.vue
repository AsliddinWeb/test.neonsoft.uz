    ...
    <header class="bg-white/90 backdrop-blur-md border-b border-slate-200/70 sticky top-0 z-30 shadow-sm">
      <div class="max-w-6xl mx-auto px-4">
        ...
        <div v-if="mobileOpen" class="md:hidden pb-3 space-y-1">
          <router-link @click="mobileOpen=false" to="/" class="block px-4 py-2.5 rounded-lg text-sm font-medium text-slate-700 hover:bg-brand-50" active-class="!bg-brand-50 !text-brand-700">Bosh sahifa</router-link>
